...
;(function () {
  ...
  function reportData(str) {
    var elem = document.getElementById('feDataReport');
    var serverHost = elem.src.split('/static/reportData.js?appId')[0];
    var appId = elem.src.split('/static/reportData.js?appId=')[1];
    //通过Image对象请求发送数据
